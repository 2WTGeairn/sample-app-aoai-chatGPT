                        ...
                        {!lastQuestionRef.current ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>SOW Generation</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Hello! I'm here to assist you with generating a Statement of work.</h2>
                            </Stack>
                        ) : (
